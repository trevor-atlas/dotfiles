...
`dotspacemacs/user-config' first."
  (setq org-agenda-files (list "~/Dropbox/notes/work-todo.org"
                               "~/Dropbox/personal-todo.org"))
  )
...
(custom-set-faces
 ...
 '(spacemacs-micro-state-binding-face ((t (:foreground "#BF616A" :weight normal)))))
