...
local theme = {
  syntax = {
    ...
    ['@tag'] = { fg = palette.dark_purple },

    -- <div attribute="" />
    TSTagAttribute = { fg = '#f0d197' },
    ['@tag.attribute'] = { fg = '#f0d197' },
  ...
  bufferline = {
    ...
    -- BufferLineTabClose = { fg = palette.red, bg = palette.bg },
    ...
    BufferLineError = { fg = palette.red, bg = palette.red },
    BufferLineErrorDiagnostic = { fg = palette.autumnYellow, bg = palette.autumnYellow },
  },
  hop = {
    HopNextKey = { fg = palette.red, bold = true },
    HopNextKey1 = { fg = palette.teal, bold = true },
  ...
  notify = {
    ...
    NotifyDEBUGIcon = { fg = palette.teal },
    ...
    NotifyDEBUGTitle = { fg = palette.teal },
  ...
  vim_wiki = {
    VimwikiLink = { fg = palette.teal, bg = palette.none },
    ...
    VimwikiHeader4 = { fg = palette.teal, bg = palette.none, bold = true },
